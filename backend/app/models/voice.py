...
声音克隆模型
"""
from sqlalchemy import Column, BigInteger, String, DateTime, Enum, Text, DECIMAL, Index
...
class VoiceClone(Base):
    ...
    digital_human_id = Column(BigInteger, nullable=True, comment="关联数字人ID")
    ...
    is_default = Column(Enum("0", "1"), default="0", comment="是否为默认音色")
